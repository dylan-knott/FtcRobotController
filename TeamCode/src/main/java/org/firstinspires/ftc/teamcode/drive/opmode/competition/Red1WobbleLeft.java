...
public class Red1WobbleLeft extends LinearOpMode{
    ...
    public void runOpMode() throws InterruptedException {
        ...
        ThreadGroup testGroupP =new ThreadGroup("PTestGroup");
        Thread t1= new Thread(testGroupP, Thread.currentThread());
        ThreadGroup testGroupC = new ThreadGroup(testGroupP, "CtestGroup");
        Thread shooterThread = new Thread(testGroupP,shooter);
        shooterThread.start();
